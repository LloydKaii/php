        ...
        <div class="row">
            ...
            <aside class="col-lg-3">
                <div class="team-list bg-dark p-3 rounded" style="max-height: 500px; overflow-y: auto;">
                    ...
                    @if (Auth::user())
                    @if ($check)
                    <button class="mb-5 btn btn-success" disabled>Bạn đã đăng ký</button>
                    <a href="/delurex/{{$exerciseById->id}}" class="mb-5 btn btn-danger">Hủy đăng ký</a>
                    @else
                    @if ($check1)
                    <a href="/regisex/{{$exerciseById->id}}" class="mb-5 btn btn-primary">Đăng ký bài học để xem full</a>
                    @else
                    <a href="/to-package" class="mb-5 btn btn-danger">Mua gói tập để được đăng ký bài học</a>
                    @endif
                    @endif
                    @else
                    <a href="/login" class="mb-5 btn btn-primary">Đăng nhặp để xem thêm bài học!</a>
                    @endif
            ...
            <aside class="col-lg-3">
                <div class="coach-info bg-dark p-3 rounded">
                    ...
                    <p><strong>Tên:</strong> <a href="/profile/{{ $coachById->id }}">{{ $coachById->name }}</a></p>
