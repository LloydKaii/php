        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="breadcrumb-text">
                    ...
                    <div class="bt-option">
                        <a href="/">Trang chủ</a>
                        <span>Hồ sơ huấn luyện viên</span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="team-section spad">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="team-info">
                    <h2 class="text-white">Huấn luyện viên: {{ $coachById->name }}</h2>
                    <p class="mt-5"><strong>Tuổi:</strong> {{ $coachById->age }} tuổi</p>
                    <p><strong>Cân nặng:</strong> {{ $coachById->weight }} kg</p>
                    <p><strong>Chiều cao:</strong> {{ $coachById->height }} cm</p>
                    <p><strong>Mô tả:</strong> {{ $coachById->description_user }}</p>
        ...
        <h2 class="text-white mb-5 mt-5">Danh sách bài tập của huấn luyện viên</h2>
        <div class="row">
            @if (isset($exListByCoachId))
            @foreach ($exListByCoachId as $item)
            <div class="col-lg-4 col-sm-6">
                <div class="ts-item">
                    <!-- Nửa trên là ảnh -->
                    <div class="ts-img" style="height: 250px; background: url('{{$item->imageExercise}}') no-repeat center center; background-size: cover;">
                    </div>
